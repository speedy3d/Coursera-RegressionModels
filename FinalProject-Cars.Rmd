...
Using this model we can determine that this model can only explain about 34% (Adjusted R-squared value of 0.3598) of the variance in MPG. Therefore we should try another model to examine the other variables in the mtcars dataset.
...
Using R step function to step through the itterations of variables to determine which model would be the best.
