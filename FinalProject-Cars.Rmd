...
This model now accounts for about 84% of the MPG variance (Adjusted R-squared 0.8401) which is better than our model that accounts for all the variables. The final model included four variables (number of cylinders, horsepower, weight, and transmission). We see that the   
