...
head(mtcars,2) #Examine how the data is structured in mtcars
...
Using this model we can determine that this model, while significant, can only explain about 36% (Multiple R-squared value of 0.3598) of the variance in MPG. Therefore we shoudl try another model to examine the other variables in the mtcars dataset.

Accoding to the (*see* **Figure 2**)
