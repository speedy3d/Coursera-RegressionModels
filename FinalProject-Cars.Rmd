...
Accoding to the matrix scatterplot of all the variables in mtcars (*see* **Figure 2**) the there are a number of other variables that show significant correlation with MPG. Therefore exparimentation is necessary to create a model with the highest multiple R-squared value. 
...
Pairs chart covering the variances between many different variables in the mtcars dataset. 
